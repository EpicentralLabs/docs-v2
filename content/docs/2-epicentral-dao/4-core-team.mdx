...
|------------------------|-------------|
| **Smart Contract Operations** | Implement smart contract deployments and configuration changes |
| **Protocol Development** | Coordinate protocol development, audits, and infrastructure integration |
| **External Communications** | Represent the DAO in pre-approved communication with service providers, security firms, or integration partners |
...
|-------------------|-------------------|
| Modify protocol economics | [Epicentral Labs DAO](/docs/2-epicentral-dao) governance |
| Negotiate binding commercial terms | [Epicentral Labs DAO](/docs/2-epicentral-dao) governance |
| Add or remove Members | Operating Agreement |
| Reallocate [DAO Treasury](/docs/2-epicentral-dao) assets | [Epicentral Labs DAO](/docs/2-epicentral-dao) governance |
| Alter governance processes | Operating Agreement |

The [Epicentral Labs DAO](/docs/2-epicentral-dao) and/or Members under the Operating Agreement expressly reserve these powers.
...
The [Epicentral Labs DAO](/docs/2-epicentral-dao) retains **exclusive authority** over the [DAO Treasury](/docs/2-epicentral-dao) and sets the Core Team's operational budget through on-chain governance.
