...
<Accordions type="single" className="my-4">
  ...
  <Accordion title="Θ - Theta" value="theta">
    Theta represents the option's time decay, showing how much value the option loses each day as the [expiration date](/docs/4-opx/1-option-basics#terminology) approaches. Theta quantifies the time value component of an option's [premium](/docs/4-opx/1-option-basics#terminology) and measures how much value an option loses as time passes.
  ...
  <Accordion title="ν - Vega" value="vega">
    Vega measures the sensitivity of the option's price relative to changes in the underlying token's [volatility](/docs/4-opx/1-option-basics#terminology). Vega quantifies the impact of a 1% change in volatility and helps traders understand how market uncertainty affects option pricing.
