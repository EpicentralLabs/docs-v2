...
Sellers select the asset and quantity that will collateralize their position. If the provided collateral is insufficient, the seller may borrow additional coverage from the [Option Margin Liquidity Pool (OMLP)](/docs/4-opx/opx-main/1-omlp) to complete the required margin structure.
...
For a comprehensive breakdown of the fee structure, allocation details, and user fee schedules, refer to the [Fees](/docs/4-opx/opx-main/2-fees) page. All applicable fees and their breakdown are transparently displayed within the interface at each stage of position creation and management.
